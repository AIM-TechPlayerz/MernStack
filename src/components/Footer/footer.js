...
export default function Footer() {
  return (
    <footer className="mt-auto p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 bottom-0">
    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
        
        © 2023 <a href="https://flowbite.com" className="hover:underline" target="_blank">Haidertech™</a>. All Rights Reserved.
    </span>
